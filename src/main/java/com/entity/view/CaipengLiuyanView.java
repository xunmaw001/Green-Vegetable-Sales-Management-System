...
public class CaipengLiuyanView extends CaipengLiuyanEntity implements Serializable {
	...
	public CaipengLiuyanView() {

	}

	public CaipengLiuyanView(CaipengLiuyanEntity caipengLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, caipengLiuyanEntity);
