...
<template>
    <div class="main-content">
            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '配送人员姓名' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.peisongName" placeholder="配送人员姓名" clearable></el-input>
                    </el-form-item>
                     
                    <el-form-item :label="contents.inputTitle == 1 ? '配送人员手机号' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.peisongPhone" placeholder="配送人员手机号" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/shucaixiaoshou/upload/shangpinOrderMuBan.xls"
                        >批量导入商品订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinOrder','导入导出')"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 3 && role == '用户'" type="primary" icon="el-icon-sold-out" size="mini" @click="refund(scope.row.id)">退款</el-button>
                                  <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 3 && role == '管理员'" type="primary" icon="el-icon-reading" size="mini" @click="deliverModel(scope.row.id)">发货</el-button>
		...
		<el-dialog
                ...
                width="30%">
            <el-select v-model="peisongId" filterable placeholder="请选择配送人员">
                <el-option
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.peisongPhone!= '' && this.searchForm.peisongPhone!= undefined) {
                    params['peisongPhone'] = '%' + this.searchForm.peisongPhone + '%'
                }
            ...
            deliver(){
                let _this =this;
                if(_this.deliverId == null || _this.deliverId == ""){
                    this.$message.error('订单id不能为空');
                    return false;
                }
                if(_this.peisongId == null || _this.peisongId == ""){
                    this.$message.error('配送人员不能为空');
                    return false;
                }
                this.$http({
                    url: "shangpinOrder/deliver?id="+_this.deliverId +"&peisongId="+_this.peisongId,
                    method: "get",
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.$message({
