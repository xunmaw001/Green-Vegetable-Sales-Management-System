    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='peisong'">
                    <el-form-item class="select" v-if="type!='info'"  label="配送人员" prop="peisongId">
                        <el-select v-model="ruleForm.peisongId" filterable placeholder="请选择配送人员" @change="peisongChange">
                            <el-option
                                    v-for="(item,index) in peisongOptions"
                                    v-bind:key="item.id"
                                    :label="item.peisongName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='peisong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="配送人员姓名" prop="peisongName">
                        <el-input v-model="peisongForm.peisongName"
                                  placeholder="配送人员姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="配送人员姓名" prop="peisongName">
                ...
                <el-col :span="12"  v-if="sessionTable !='peisong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="配送人员手机号" prop="peisongPhone">
                        <el-input v-model="peisongForm.peisongPhone"
                                  placeholder="配送人员手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="配送人员手机号" prop="peisongPhone">
                            <el-input v-model="ruleForm.peisongPhone"
                                      placeholder="配送人员手机号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="sessionTable !='peisong' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.peisongPhoto" label="配送人员头像" prop="peisongPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (peisongForm.peisongPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.peisongPhoto" label="配送人员头像" prop="peisongPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.peisongPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <input id="peisongId" name="peisongId" type="hidden">
               <el-col :span="12">
...
<script>
    ...
    export default {
        ...
        created() {
         ...
         this.$http({
             url: `peisong/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.peisongOptions = data.data.list;
            }
         });
         this.$http({
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='peisongId'){
                          this.ruleForm.peisongId = obj[o];
                          this.ro.peisongId = true;
                          continue;
                      }
                      if(o=='buyNumber'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.peisongChange(data.data.peisongId)
