...
import center from '@/views/center'
        ...
        import caipeng from '@/views/modules/caipeng/list'
        import caipengLiuyan from '@/views/modules/caipengLiuyan/list'
        import caipengyuyue from '@/views/modules/caipengyuyue/list'
        ...
        import dictionaryCaipengyuyueYesno from '@/views/modules/dictionaryCaipengyuyueYesno/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryCaipengyuyueYesno',
        name: '是否同意',
        component: dictionaryCaipengyuyueYesno
    }
    ,{
    ...
    ,{
        path: '/caipengLiuyan',
        name: '菜棚留言',
        component: caipengLiuyan
      }
    ,{
        path: '/caipengyuyue',
        name: '菜棚预约',
        component: caipengyuyue
      }
    ,{
        path: '/cart',
        name: '购物车',
